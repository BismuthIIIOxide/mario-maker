var blockser = [
  ...
  {block: 'O', name: 'Coin'},
  {block: 'δ', name: 'Fake block'},
  {block: "χ", name: "Fake brick"},
  {block: "+", name: "Instakill lava"},
  {block: "I", name: "Invisible block"},
  {block: "t", name: "Turtle monster"},
  {block: "Z", name: "Invisible lava"},
  {block: "e", name: "Elevator"},
